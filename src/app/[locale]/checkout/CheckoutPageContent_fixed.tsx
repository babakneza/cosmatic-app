...
export default function CheckoutPageContent({ locale }: CheckoutPageContentProps): React.ReactElement {
    ...
    const handleOrderConfirm = async () => {
        ...
        try {
            ...
            const convertToDirectusFormat = (addr: Address) => {
                ...
                if (addr.country_id) json.countries = addr.country_id;

                return json;
            };

            const shippingAddressJson = convertToDirectusFormat(shippingAddress);
            const billingAddressJson = billingAddress
                ? convertToDirectusFormat(billingAddress)
                : shippingAddressJson;
