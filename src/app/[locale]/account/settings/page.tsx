...
import { AlertCircle, Loader, CheckCircle, ArrowLeft, Lock } from 'lucide-react';

interface SettingsPageProps {
    params: Promise<{ locale: string }>;
}

export default function SettingsPage({ params: paramsPromise }: SettingsPageProps) {
        ...
        <div className="min-h-screen bg-gray-50 py-4 sm:py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
                ...
                <button
                    ...
                    className="flex items-center gap-2 text-gold hover:text-amber-600 mb-6 transition font-medium"
                >
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6 border-b-4 border-gold">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-gradient-to-br from-gold to-amber-600 rounded-full flex items-center justify-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">
                                {t('account.manage_your_settings')}
                            </p>
                        </div>
                    </div>
                </div>
